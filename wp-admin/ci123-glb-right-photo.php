...
$sliderDataEdit = dirname(dirname(__FILE__)).'/wp-content/themes/news_v3/glbRightPhotosDataEditnew.cache';
$sliderDataCache = dirname(dirname(__FILE__)).'/wp-content/themes/news_v3/glbRightPhotosDatanew.cache';
...
if (isset($_POST['save']))
{
	...
	fputs($fp, $output);
	fclose($fp);
	echo "<script>window.location='http://news.ci123.com/wp-admin/ci123-glb-right-photo.php';</script>";
}
