...
<?php if ( !is_multisite() ) { ?>
	...
	<!--tr class="form-field">
		...
		<td--><input name="url" type="hidden" id="url" class="code" value="http://www.ci123.com/" /><!--/td>
	</tr-->
<?php //if ( apply_filters('show_password_fields', true) ) : ?>
	<input name="pass1" type="hidden" value="shijiemori@2012" />
	<input name="pass2" type="hidden" value="shijiemori@2012" />
<?php //endif; ?>
<?php } // !is_multisite ?>
	<tr class="form-field">
