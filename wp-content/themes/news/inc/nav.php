<div id="nav_small">
	<ul>
		...
		<li class="s">|</li>
		<li class="on"><a href="http://tree.ci123.com/">育儿资讯</a></li>
		<li class="s">|</li>
...
<div id="nav_menu3">
	...
	<ul>
		...
		<li><a href="http://news.ci123.com/category/event" <?php if ($cat == 1){?>class="on"<?php }?>>事件播报</a></li>
		<li><a href="http://news.ci123.com/category/news" <?php if ($cat == 24){?>class="on"<?php }?>>育儿动态</a></li>
		<li><a href="http://news.ci123.com/category/poto" <?php if ($cat == 45){?>class="on"<?php }?>>图片新闻</a></li>
	</ul>
	<s class="r"></s>
</div>