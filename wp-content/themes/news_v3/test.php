...
?>
	...
	<div class="hot mgt10">
	   ...
	   <?php if($v['color']=="blue"){?>
		  <a style="text-decoration: none; color:#ffffff; padding: 1px 6px 3px; background-color: #8abde8" href="<?php echo $v['url'];?>"><?php echo $v['word'];?></a>
	   <?php }else{?>
		   <a style="text-decoration: none; color:#ffffff; padding: 1px 6px 3px; background-color: #ffb568" href="<?php echo $v['url'];?>"><?php echo $v['word'];?></a>
	   <?php }?>
	   <?php }?>
	   </ul>
</div>
