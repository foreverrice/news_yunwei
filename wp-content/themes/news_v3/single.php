				...
				<div class="l">
					...
					<div class="post" id="post">
						...
						<div class="postInfo">
							...
							<span>作者：<?php the_author_lastname().the_author_firstname(); ?></span>
						</div>
...
<script src="http://cpro.baidustatic.com/cpro/ui/c.js" type="text/javascript"></script>
					...
					<a href="#" class="bds_weixin" data-cmd="weixin" title="分享到微信"><a href="#" class="bds_qzone" data-cmd="qzone" title="分享到QQ空间
					"></a><a href="#" class="bds_tsina" data-cmd="tsina" title="分享到新浪微博"></a><a href="#" class="bds_douban" data-cmd="douban" title="分享到豆瓣网"></a><a href="#" class="bds_more" data-cmd="more"></a></div>
							<script>
