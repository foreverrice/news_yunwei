...
$dated = date("Y-m-d",strtotime("-15 day"));
...
//$res = $ms->getRow($sql);
$sql = "select * from `news_posts` where `post_status`='publish' and `post_date`>'{$dated}' order by ID desc limit 300";
$res = $ms->getRows($sql);
if($res){
