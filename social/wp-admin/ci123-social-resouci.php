...
$sliderDataEdit = dirname(dirname(__FILE__)).'/wp-content/themes/news_v3/socialRSCDataEdit.cache';
$sliderDataCache = dirname(dirname(__FILE__)).'/wp-content/themes/news_v3/socialRSCData.cache';
...
$class = $sliderData['class'] ? $sliderData['class'] : array('', '', '', '');
...
if (isset($_POST['save']))
{
	...
	fputs($fp, $output);
	fclose($fp);
	echo "<script>window.location='http://news.ci123.com/wp-admin/ci123-social-resouci.php';</script>";
}
...
<form name="myform" method="POST" action="">
	...
	<div class="box fl">
		...
		<div class="">
			...
			<p><input name="class<?=$i?>" value="<?php echo $class[$i] ? $class[$i] : 0; ?>" class="ipt" placeholder="高亮填1" /></p>
		</div>
	</div>
	<?php } ?>
