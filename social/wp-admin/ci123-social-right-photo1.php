...
$sliderDataEdit = dirname(dirname(__FILE__)).'/wp-content/themes/news_v3/socialRightPhotos1DataEdit.cache';
$sliderDataCache = dirname(dirname(__FILE__)).'/wp-content/themes/news_v3/socialRightPhotos1Data.cache';
...
if (isset($_POST['save']))
{
	...
	fputs($fp, $output);
	fclose($fp);
	echo "<script>window.location='http://news.ci123.com/wp-admin/ci123-social-right-photo1.php';</script>";
}
