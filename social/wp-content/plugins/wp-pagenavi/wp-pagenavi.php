...
function _pagenavi_init() {
	...
	$options = new scbOptions( 'pagenavi_options', __FILE__, array(
		//'pages_text'    => __( '%CURRENT_PAGE% of %TOTAL_PAGES%', 'wp-pagenavi' ),
		'current_text'  => '%PAGE_NUMBER%',
		'page_text'     => '%PAGE_NUMBER%',
		'first_text'    => __( '1', 'wp-pagenavi' ),
		'last_text'     => __( '%TOTAL_PAGES%', 'wp-pagenavi' ),
		'prev_text'     => __( '上一页', 'wp-pagenavi' ),
		'next_text'     => __( '下一页', 'wp-pagenavi' ),
