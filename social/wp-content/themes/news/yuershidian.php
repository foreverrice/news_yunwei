<?php
	...
	$voteData = json_decode(file_get_contents("http://news.ci123.com/wp-content/themes/news/shiDianRpc.php?id=".$shidianData['shidianqi'][0].""));
...
<script type="text/javascript">
	$(function() { 	
		...
		$.ajax({
				type: "POST",
				url: "http://news.ci123.com/wp-content/themes/news/toupiaoajax.php?rnd=" + Math.random(), 
				data: {id:id},
				dataType: "JSON",
				success:function(oJ)
			{
		...
		$.ajax({
				type: "POST",
				url: "http://news.ci123.com/wp-content/themes/news/toupiaoajaxb.php?rnd=" + Math.random(), 
				data: {id:id},
				dataType: "JSON",
				success:function(oJ)
			{
